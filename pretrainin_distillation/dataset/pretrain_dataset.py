...
MIMIC_CXR_DATA_DIR = os.path.join(BASE_DIR, "../data/mimic-cxr-jpg")
MIMIC_CXR_MASTER_TRIPLET_CSV = os.path.join(BASE_DIR, "../data/mimictriplet.csv")
