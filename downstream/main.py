...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelname', type=str, default='DeiT-B', help='model name')
    ...
    parser.add_argument('--dataname', type=str, default='unseenchestxray14', choices=[ "mimic5_200_u", "mimic5_200_p", 'unseenchestx10', 'seenchestx10',
