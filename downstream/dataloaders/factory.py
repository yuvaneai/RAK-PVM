...
def load_unseenchestx10(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = UnseenChestx10_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestx_det10/unseen_train.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/ChestX-Det10-Dataset/train-old"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    )
    testset = UnseenChestx10_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestx_det10/unseen_test.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/ChestX-Det10-Dataset/test_data"),
...
def load_seenchestx10(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = SeenChestx10_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestx_det10/seen_train.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/ChestX-Det10-Dataset/train-old"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    ...
    testset = SeenChestx10_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestx_det10/seen_test.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/ChestX-Det10-Dataset/test_data"),
        transform=test_augmentation(img_size=img_size, mean=mean, std=std),
        split="test"
    )
...
def load_mimic5_200_p(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = MIMIC5_200_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/mimic_5_200_p/train_p.csv"),  # proportion
        root_dir=os.path.join(BASE_DIR, "../data/mimic-cxr-jpg"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    )
    ...
    testset = MIMIC5_200_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/mimic_5_200_p/test_p.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/mimic-cxr-jpg"),
        transform=test_augmentation(img_size=img_size, mean=mean, std=std),
        split="test"
    )
...
def load_mimic5_200_u(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = MIMIC5_200_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/mimic_5_200_u/train_u.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/mimic-cxr-jpg"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    ...
    testset = MIMIC5_200_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/mimic_5_200_u/test_u.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/mimic-cxr-jpg"),
        transform=test_augmentation(img_size=img_size, mean=mean, std=std),
        split="test"
    )
...
def load_seenchestxray14(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = SeenChestxray14_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestxray14_5+5/seen_train_p.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/Chestxray"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    )
    testset = SeenChestxray14_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestxray14_5+5/seen_test_p.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/Chestxray"),
        transform=test_augmentation(img_size=img_size, mean=mean, std=std),
        split="test"
    )
...
def load_unseenchestxray14(datadir: str, data_pct, img_size: int, mean: tuple, std: tuple):
    trainset = UnSeenChestxray14_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestxray14_5+5/unseen_train_p.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/Chestxray"),
        transform=train_augmentation(img_size=img_size, mean=mean, std=std),
        split="train",
        data_pct=data_pct
    ...
    testset = UnSeenChestxray14_Dataset(
        csv_file=os.path.join(BASE_DIR, "../data_split/chestxray14_5+5/unseen_test_p.csv"),
        root_dir=os.path.join(BASE_DIR, "../data/Chestxray"),
        transform=test_augmentation(img_size=img_size, mean=mean, std=std),
        split="test"
    )
