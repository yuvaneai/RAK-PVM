...
def process_dataframe(df):
    ...
    df["findings_triplet"] = triplet_list
    return df


# ----------------- 主程序 -----------------

input_file = "E:/3_CL_coding/mimic_data_20260304/splits/raw_mimic_part_3_triplet_impression.csv"        # ✅ 改这个来处理不同文件
output_file = "E:/3_CL_coding/mimic_data_20260304/splits/raw_mimic_part_3_triplet_impression_findings.csv"
